...
--
-- Table structure for table `empregestration`
--

DROP TABLE IF EXISTS `empregestration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `empregestration` (
  ...
  `contact_number` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
--
-- Dumping data for table `empregestration`
--

LOCK TABLES `empregestration` WRITE;
/*!40000 ALTER TABLE `empregestration` DISABLE KEYS */;
INSERT INTO `empregestration` VALUES (3,'rushikesh','dd','ff','12','768','iou','nf','45','67');
/*!40000 ALTER TABLE `empregestration` ENABLE KEYS */;
UNLOCK TABLES;
